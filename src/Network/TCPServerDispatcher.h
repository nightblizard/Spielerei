...
public:
	TCPServerDispatcher(TCPServerConnectionFactory::Ptr pFactory, Poco::ThreadPool& threadPool, Poco::Net::TCPServerParams::Ptr pParams);
	...
	void enqueue(const Poco::Net::StreamSocket& socket);
...
private:
	...
	int _rc;
	Poco::Net::TCPServerParams::Ptr _pParams;
	int  _currentThreads;
	...
	std::vector<std::shared_ptr<TCPServerConnection>> _connections;
};
...
// inlines
//
inline const Poco::Net::TCPServerParams& TCPServerDispatcher::params() const
{
	return *_pParams;
}
