...
{
public:
	TCPServer(TCPServerConnectionFactory::Ptr pFactory, const Poco::Net::ServerSocket& socket, Poco::Net::TCPServerParams::Ptr pParams = 0);
	...
	TCPServer(TCPServerConnectionFactory::Ptr pFactory, Poco::ThreadPool& threadPool, const Poco::Net::ServerSocket& socket, Poco::Net::TCPServerParams::Ptr pParams = 0);
	/// Creates the TCPServer, using the given ServerSocket.
	///
	/// If no TCPServerParams object is given, the server's TCPServerDispatcher
	/// creates its own one.
	...
	const Poco::Net::TCPServerParams& params() const;
...
protected:
	...
	static std::string threadName(const Poco::Net::ServerSocket& socket);
