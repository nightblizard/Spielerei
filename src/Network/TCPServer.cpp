...
TCPServer::TCPServer(TCPServerConnectionFactory::Ptr pFactory, const Poco::Net::ServerSocket& socket, Poco::Net::TCPServerParams::Ptr pParams) :
	_socket(socket),
...
TCPServer::TCPServer(TCPServerConnectionFactory::Ptr pFactory, Poco::ThreadPool& threadPool, const Poco::Net::ServerSocket& socket, Poco::Net::TCPServerParams::Ptr pParams) :
	_socket(socket),
...
const Poco::Net::TCPServerParams& TCPServer::params() const
{
...
std::string TCPServer::threadName(const Poco::Net::ServerSocket& socket)
{
